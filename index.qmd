...
<center>
<br>
<h3>A friendly solution to scary problems</h3>
...
## <span style="font-size:70%">Scary problems with non-statistical solutions</span>
...
## <span style="font-size:80%">What is a pipeline?

<center>
<img src="./images/pipeline-def.png" height="200">
</center>

* A collection of computational steps.
...
## Simple example: air quality data analysis {data-background-color=skyblue}



## Simple analysis of air quality data
...
list(
  ...
  tar_target(plot, plot_results(model, data))
)
```
...
## Scary example: Bayesian model validation {data-background-color=skyblue}
